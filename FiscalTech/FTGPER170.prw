...
Processa({ || fMontaTPR(nOrdem, dDataRef, @lSalInc, @lTrataTrf, @aTransf, , cAcessaSRA, cFiltro070)}, STR0010) //"PROVISŽO DE FERIAS "
...
//MONTA O ARQUIVO TEMPORARIO "TPR" A PARTIR DO SRA E SRE
Processa({ || fMontaTPR(nOrdem, dDataRef, @lSalInc, @lTrataTrf, @aTransf, , cAcessaSRA, cFiltro070)}, STR0058) //"PROVISŽO DE 13º SALARIO"
...
Processa({ || fMonta_TPR("","",nOrdem,dDataRef,@lSalInc,@lTrataTrf,@aTransf,,cAcessaSRA,,lTodosCpos)},STR0089) //"PROVISŽO DE PLR"
