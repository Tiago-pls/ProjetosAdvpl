...
trCell():New(oDados,"D2_CF       ","QRY" ,  ,"@!",TamSx3("D2_CF")[1])
...
trCell():New(oDados,"D2_CUSTO1   ","QRY" ,  ,"@E 999,999,999.99",17)
trCell():New(oDados,"CMV         ","QRY" ,  ,"@E 999,999,999.99",17)
trCell():New(oDados,"D2_NUMSERI  ","QRY" ,  ,"@E 999,999,999.99",17)
...
cQuery += " F2_FILIAL, F2_DOC, D2_CF, F2_CLIENTE,  F2_LOJA, A1_NOME , "    + cLFRC
...
cQuery += " D2_COD, B1_DESC, D2_QUANT, D2_TOTAL, D2_CUSTO1, D2_UM,  B1_XPOTENC , B1_XVLPOTE, "    + cLFRC
cQuery += " case"  + cLFRC
...
cQuery += " else ' '"  + cLFRC
cQuery += " end D2_AXPLICA , round (((D2_TOTAL - D2_CUSTO1) / D2_TOTAL)*100,2) CMV , D2_NUMSERI "  + cLFRC
...
cQuery += " Where F2_FILIAL >='"+MV_PAR01+"' and F2_FILIAL <= '"+MV_PAR02+"'" + cLFRC
cQuery += " And F2_EMISSAO >='"+ DtoS(MV_PAR03)+"' and F2_EMISSAO <= '"+DtoS(MV_PAR04)+"'" + cLFRC
cQuery += " and F2_CLIENTE >='"+MV_PAR05+"' and F2_CLIENTE <= '"+MV_PAR06+"'" + cLFRC
cQuery += " and F2_LOJA >='"+MV_PAR07+"' and F2_LOJA <= '"+MV_PAR08+"'" + cLFRC
cQuery += " and F2_VEND1 >='"+MV_PAR09+"' and F2_VEND1 <= '"+MV_PAR10+"'" + cLFRC
