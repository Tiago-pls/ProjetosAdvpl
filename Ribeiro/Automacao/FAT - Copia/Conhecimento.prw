...
nLin += 20
oPrint:Say(nLin,780,cRazSoc,oFont14b ,140)
nLin += 50
oPrint:Say(nLin,780,cEnder,oFont13 ,140)
nLin += 50
oPrint:Say(nLin,780,cFone,oFont13 ,140)
nLin += 50
oPrint:Say(nLin,780,cCnpj,oFont13 ,140)
nLin += 50
oPrint:Say(nLin,780,cIE,oFont13 ,140)

oPrint:Box(100,1890,390,2400)
oPrint:Line(150,1770,150,2400)

oPrint:Say(170,1920,"Série: "+ cSerie,oFont12 ,100)
oPrint:Say(240,1920,"N.Fiscal: "+ cNFe,oFont12 ,100)
oPrint:Say(310,1920,"Dt.Emissão: "+ cEmissao,oFont12 ,100)
...
nLin += 50
oPrint:Line(nLin,1890,150,2400)
...
oPrint:Say(nLin,900,"Horário",oFont10b ,200)
oPrint:Say(nLin,1200,"Tipo Evento",oFont10b ,200)
oPrint:Say(nLin,1550,"Estado",oFont10b ,200)
oPrint:Say(nLin,1800,"Protocolo",oFont10b ,200)
nLin += 50
oPrint:Say(nLin,110,"Data da CC-e ",oFont11 ,200)
oPrint:Say(nLin,900,"Data da CC-e ",oFont11 ,200)
oPrint:Say(nLin,1200,"Tipo Evento",oFont11 ,200)
oPrint:Say(nLin,1550,"Estado",oFont11 ,200)
oPrint:Say(nLin,1800,"Protocolo",oFont11 ,200)
nLin += 50
oPrint:Line(nLin,100,nLin,2400)

nLin += 80
oPrint:Say(nLin,110,"Correção a ser considerada",oFont11 ,200)
...
MSBAR('CODE128',55 , 10,alltrim(cChaveNfe),oPrint,.F.,,.T.,0.013,0.7,,,,.F.)
