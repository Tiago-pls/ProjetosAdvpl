...
ฑฑบDesc.     ณ Consulta do cadastro de produtos 		                  บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Teletex                                                   บฑฑ
...
Local cComboBo2 := ""
Local aGrupo	:= {}
Local cCampoSB1 := "B1_COD#B1_DESC#B1_GRUPO#B1_TL_DGRU#B1_TL_SUBG#B1_TL_DSBG#B1_TL_PARN"
Local aProd		:= {}
...
Private _Ret	:= ''
Public _aIndexSB1 := {}
Public _cFiltra := "B1_MSBLQL<>'1' "+iif(lTipo,''," .AND. (!B1_GRUPO $ ('000011#000012#000013#000042'))")
Static oDlgProd
...
@ 152, 013 RADIO oRadMenu1 VAR  nRadMenu1 ITEMS "Desc Produto","Desc Grupo","Desc Subgrupo","PartNumber" SIZE 061, 039 OF oDlgProd COLOR 0, 16777215 PIXEL
...
_cFiltra+= " .and. B1_MSBLQL<>'1' "+iif(lTipo,''," .AND. (!B1_GRUPO $ ('000011#000012#000013#000042'))")

if empty(cPesq)
	_cFiltra:= " B1_MSBLQL<>'1' "+iif(lTipo,''," .AND. (!B1_GRUPO $ ('000011#000012#000013#000042'))")
Endif
