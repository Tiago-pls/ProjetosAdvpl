...
Local cColTipo 	 := ""
private RetArq := ""
private ctiponfe := ""// if( type("ctiponfe")=="U", If(Substr(MV_PAR01,1,1) == "2","ENTRADA","SAIDA"), ctiponfe    ) // If(Substr(MV_PAR01,1,1) == "2","ENTRADA","SAIDA")
DEFAULT nTipo  := 1
public cTpnfeRib := ""

cTpnfeRib:= if ( Empty(cTpnfeRib),  If(Substr(MV_PAR01,1,1) == "2","ENTRADA","SAIDA"), cTpnfeRib)
ctiponfe := cTpnfeRib
If lCte
	cColTipo := "2"
