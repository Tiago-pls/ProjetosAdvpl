...
Static Function ImpCabecalho(oPDF, lFirst)
	...
	IF lFirst
		...
		IF SUA->( FieldPos("UA_TPFRETE") ) != 0 .And. ! Empty(SUA->UA_TPFRETE)
			...
			oPDF:SayAlign( A4ToRow(38), A4ToCol(160), "Valor do Frete:", oArial10,100,,,ALIGN_LEFT)
			oPDF:SayAlign( A4ToRow(38), A4ToCol(182), TransForm(SUA->UA_FRETE,PesqPict("SUA","UA_FRETE") ) , oArial10,100,,,ALIGN_LEFT)
		EndIF
		...
		//vendedor
		oPDF:SayAlign( A4ToRow(42), A4ToCol(160), "Vendedor:", oArial10,100,,,ALIGN_LEFT)
		oPDF:SayAlign( A4ToRow(42), A4ToCol(175), alltrim(SA3->A3_NOME) + IIF( ! Empty(SA3->A3_EMAIL) , " (" + alltrim(SA3->A3_EMAIL) + ")" , "" ), oArial10,500,,,ALIGN_LEFT)
		...
		IF SUA->( FieldPOS("UA_XSETOR") ) != 0 .And. ! Empty(SUA->UA_XSETOR)
			oPDF:SayAlign( A4ToRow(51), A4ToCol(160), "Setor: " + alltrim(SUA->UA_XSETOR), oArial10,200,,,ALIGN_LEFT)
		EndIF
...
Static Function GetProposta(aTotais)
	...
	aTotais[4][2] := TransForm(MaFisRet(,"NF_TOTAL"  )+SUA->UA_FRETE,"@E 999,999,999.99")
