...
¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
¦¦+----------+----------+-------+----------------------------+------+----------+¦¦
¦¦¦Função    ¦ BuscaPerg¦ Autor ¦ Tiago Santos               ¦ Data ¦ 26/11/21 ¦¦¦
¦¦+----------+----------+-------+----------------------------+------+----------+¦¦
...
// Busca as informações do Aprovador			
	...
	If !Empty(cAprEmail) 
		cTipo    := "LEMBRETES MOVIMENTAÇÕES FUNCIONÁRIOS"
		cAssunto := "LEMBRETES TAREFAS"
		cMsg     := "Há movimentações de funcionários realizadas."
		...
		cTracker +=' <td width="*">Admissão</td>'+cLFRC
		cTracker +=' <td width="*">Cod Func início</td>'+cLFRC
		cTracker +=' <td width="*">Desc Função </td>'+cLFRC
	 	cTracker +=' </tr>'+cLFRC	    
		While TC7->(!Eof())
